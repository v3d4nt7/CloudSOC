...
SentinelDeck is a Mac-native SOC analyst dashboard built from scratch with Streamlit and SQLite. It accepts JSON, CSV, and text/syslog logs, normalizes them locally, runs deterministic detections, maps alerts to MITRE ATT&CK tactics, and supports lightweight incident triage.
